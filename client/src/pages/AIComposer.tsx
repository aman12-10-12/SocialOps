    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
      ...
      <div className="space-y-6 text-center mt-20">
        ...
        <div className="relative group mt-12">
          <textarea placeholder="Share your idea... (e.g. A post about the launch of our new eco-friendly coffee beans)"
          ...
          <div className="absolute bottom-4 right-2.5 flex items-center gap-3 text-sm">
            ...
            className="flex items-center gap-3 bg-red-50 py-2 px-3 rounded-lg">
              ...
              <div className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out focus:outline-none 
                ...
                <span className={`pointer-events-none size-4 transform translate-y-0.5 rounded-full bg-white transition 
              ...
              <div className="flex flex-col h-full space-y-4">
                ...
                {gen.mediaUrl && (
                  <div className="rounded-xl overflow-hidden border border-slate-50 bg-slate-50">
                    <img src={gen.mediaUrl} alt="Gen" className="w-full aspect-video object-cover opacity-90 group-90 group-hover:opacity-100 transition-opacity"/>
                  </div>
                )}
                ...
                <div className="flex items-center gap-2 pt-2">
                  ...
                  className="flex-2 bg-slate-100 hover:bg-red-500 hover:text-white text-slate-600 text-xs py-2.5 rounded-lg transition-all">
                    Schedule Post
                  </button>
                </div>
              </div>
